...
namespace MvcProjectStarter.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,title,artist,album,genre,releaseDate")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,title,artist,album,genre,releaseDate")] Song song)
        {
            if (id != song.id)
            {
                return NotFound();
